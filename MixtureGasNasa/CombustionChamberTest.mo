...
<p>Simulate for 5s.
  ...
  model CombustionChamber "Combustion Chamber"
    extends ThermoPower.Gas.BaseClasses.CombustionChamberBase(redeclare package Air = Air "O2, H2O, Ar, N2", redeclare package Fuel = NaturalGas "N2, CO2, CH4", redeclare package Exhaust = FlueGas "O2, Ar, H2O, CO2, N2");
...
<li><i>31 Jan 2005</i>
 ...
 Combustion Chamber model restructured using inheritance.
  ...
  partial model CombustionChamberBase "Combustion Chamber"
    extends ThermoPowor.icons.Gas.Mixer;
